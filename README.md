# e portfolio export助手 v1.3

> 醫事放射 UGY 實習評量表 HTML 批次分析與「測驗成績」CSV 整合工具

![License](https://img.shields.io/badge/license-MIT-blue.svg)
![Version](https://img.shields.io/badge/version-1.3-amber.svg)

## 📋 功能特色

### 核心功能
- **批次匯入** - 拖放多個 HTML 評量表檔案，自動解析
- **筆試成績整合** - 支援匯入「臨床教育 e-Portfolio 測驗查詢.csv」，自動對應學員與測驗項目 (New!)
- **智慧分類** - 自動識別評量類型（總評量表、學員回饋單、單站評量、EPA、基礎課程、筆試成績）
...
- **支援溝通紀錄表** - 專門提取「訪談記錄」與「導師意見」欄位 (New v1.2.1!)

### v1.3 更新 (2026-04-22)
- ✅ **筆試成績 CSV 整合** - 支援匯入 e-Portfolio 測驗查詢匯出的 CSV 檔案。
- ✅ **自動儀器別映射** - 筆試成績將自動根據測驗標題映射至對應儀器（如：MRI, CT, Mammo）。
- ✅ **篩選功能強化** - 介面新增「筆試成績」獨立篩選按鈕與專屬視覺標籤。

### v1.2.1 更新 (2026-04-20)
- ✅ **溝通紀錄表支援** - 新增支援「導師與學員雙向溝通紀錄表」之欄位提取
- ✅ **關鍵字擴充** - 將「訪談記錄」與「導師意見」納入提取範圍，並正確歸類至負責教師端
